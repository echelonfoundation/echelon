...
Learn about the encoding formats used on Echelon. {synopsis}
...
previous versions, specially for client encoding and signing with Ledger devices. Echelon does not
...
allows for quick reconstruction of encoded data. Echelon uses RLP to encode/decode Ethereum
...
Learn how [pending state](./pending_state.md) is handled on Echelon. {hide}
