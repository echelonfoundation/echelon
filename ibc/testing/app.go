...
import (
	...
	echelonapp "github.com/echelonfoundation/echelon/v3/app"
)

var DefaultTestingAppInit func() (ibcgotesting.TestingApp, map[string]json.RawMessage) = echelonapp.SetupTestingApp
