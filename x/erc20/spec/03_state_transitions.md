...
2. Validators of the ECHELON chain vote on the proposal using `MsgVote` and proposal passes
...
- There shouldn't exist any native Cosmos Coin ERC20 Contract (eg Echelon, Atom,
