...
Say, there are several incentives that have registered an allocation for the $ECHELON coin and the allocation meter for $ECHELON is at 97%. Then a new incentve proposal can only include an $ECHELON allocation at up to 3%, claiming the last remaining allocation capcaity from the $ECHELON rewards in the inflation pool.
