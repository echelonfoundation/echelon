...
The `EVMChannels` parameter describes the list of Echelon channels that connected to EVM compatible chains and can be used during the ibc callback action.
