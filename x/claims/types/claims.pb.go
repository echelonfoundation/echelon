...
// source: echelon/claims/v1/claims.proto
...
type Claim struct {
	// action enum
	Action Action `protobuf:"varint,1,opt,name=action,proto3,enum=echelon.claims.v1.Action" json:"action,omitempty"`
...
func init() {
	proto.RegisterEnum("echelon.claims.v1.Action", Action_name, Action_value)
	proto.RegisterType((*Claim)(nil), "echelon.claims.v1.Claim")
	proto.RegisterType((*ClaimsRecordAddress)(nil), "echelon.claims.v1.ClaimsRecordAddress")
	proto.RegisterType((*ClaimsRecord)(nil), "echelon.claims.v1.ClaimsRecord")
}

func init() { proto.RegisterFile("echelon/claims/v1/claims.proto", fileDescriptor_a7153f2307523893) }
